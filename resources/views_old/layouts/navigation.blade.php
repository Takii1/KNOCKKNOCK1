        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('AllCategory')" :active="request()->routeIs('AllCategory')">
                        {{ __('Category') }}
                    </x-nav-link>
                    <x-nav-link :href="route('AllProduct')" :active="request()->routeIs('AllProduct')">
                        {{ __('Product') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('VendorPayment')" :active="request()->routeIs('VendorPayment')">
                        {{ __('Vendor Payments') }}
                    </x-nav-link>
                </div>
            </div>
