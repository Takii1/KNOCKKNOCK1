              ...
              <div class="_27033455">
                  <div class="b7cdd9f7">
                    <span class="_7978e49c _2e82a662 a695f1e9"
                      >Images before taking giving/taking possesion product</span
                    >
                  </div>
                  <div class="cb852a68">
                    <div class="cb8c9afa">
                    ...
                    <div class="Kam_kar">
                        ...
                        <input type="text" name="product_id" value="{{$order->Product_id}}" hidden>
                        <input type="text" name="order_id" value="{{$order->id}}" hidden>
                        <input type="text" name="rentee_id" value="{{$order->User_id}}" hidden>
