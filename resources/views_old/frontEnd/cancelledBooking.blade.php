...
<!-- </div> -->
      <div class="container _5533299">
        <div class="_553321">
          <h2>@lang('public.Your Cancelled')</h2>
          <h5 class="text-muted">@lang('public.Your Cancelled rental booking')</h5>
        </div>
        <!-- <div class="_553322">
          <button class="_553323 border border-muted">Add to Calender</button>
        </div> -->
        <hr class="hr" />
        @isset($cancelledOrders)
        @if($cancelledOrders)
